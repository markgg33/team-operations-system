...
// Fetch Tickets (Including Priority)
$ticketsQuery = "SELECT t.ticket_number, t.ticket_id, t.ticket_title, t.ticket_desc, t.ticket_status, t.priority, u.first_name, u.surname 
                 FROM tickets t 
